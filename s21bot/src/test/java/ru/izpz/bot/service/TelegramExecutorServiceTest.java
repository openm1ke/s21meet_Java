...
class TelegramExecutorServiceTest {
  ...
  void execute_success_returnsOptionalWithValue() throws TelegramApiException {
    ...
    TelegramExecutorService executorService =
        new TelegramExecutorService(telegramClientProxy, metricsService);
  ...
  void execute_telegramException_returnsEmptyOptional() throws TelegramApiException {
    ...
    TelegramExecutorService executorService =
        new TelegramExecutorService(telegramClientProxy, metricsService);
    SendMessage method = SendMessage.builder().chatId("1").text("t").build();
    when(telegramClientProxy.execute(any(SendMessage.class)))
        .thenThrow(new TelegramApiException("err"));
  ...
  @Test
  void execute_runtimeException_returnsEmptyOptionalAndRecordsErrorMetric()
