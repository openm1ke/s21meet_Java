...
class MessageProcessorTest {
  ...
  @Mock private RegistrationFlow registrationFlow;

  @Mock private ConfirmedFlow confirmedFlow;

  @Mock private MetricsService metricsService;

  @InjectMocks private MessageProcessor messageProcessor;
  ...
  void handleCallbackMessage_whenHandlerThrows_sendsGenericErrorAndRecordsMetric() {
    doThrow(new RuntimeException("boom"))
        .when(callbackHandler)
        .handleCallbackMessage(1L, "d", 2, "cb");
  ...
  void parseMessage_whenStatusNull_throwsNpe() {
    ...
    org.junit.jupiter.api.Assertions.assertThrows(
        NullPointerException.class, () -> messageProcessor.parseMessage(1L, profile, "t"));
  }
