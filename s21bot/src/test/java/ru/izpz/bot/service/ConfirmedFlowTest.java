...
class ConfirmedFlowTest {
  ...
  @Mock private TelegramButtons telegramButtons;
  ...
  @Mock private TelegramWebAppMenuService telegramWebAppMenuService;

  @InjectMocks private ConfirmedFlow confirmedFlow;
    ...
    when(profileService.getProjects("abc"))
        .thenReturn(
            List.of(
                ...
                new ProjectsDto(
                    "g2", "minishell", null, null, null, null, null, null, null, null, null)));
            ...
            argThat(
                message ->
                    message.contains("🏕️ Moscow campus 🎪")
                        ...
                        && message.indexOf("🧢 Data Science: 39")
                            < message.indexOf("⚡ 👽 Intensive Parallel 76: 13")
                        && message.indexOf("⚡ 👽 Intensive Parallel 76: 13")
  ...
  void startConfirmed_menuCampus_formatsAllFloorDigitsAndNullClusterValues() {
    ...
    CampusResponse campus = new CampusResponse();
    campus.setCampusName("Kazan");
    campus.setClusters(List.of(new Clusters(null, null, -1, 1234567890)));
  ...
  void startConfirmed_menuProjects_whenNotEmpty_formatsProjectsList() {
    ...
    ProjectsDto p3 =
        new ProjectsDto("g3", "BE4_GRPCAuth", null, 600, null, null, null, "GROUP", null, null, 3);
  ...
  void startConfirmed_lastCommandNone_recordsMetricAndOnlyClearsLastCommand() {
    ...
    verify(metricsService)
        .recordButtonPress(LastCommandType.NONE.name(), ButtonMetricType.LAST_COMMAND);
    verify(callbackHandler).setLastCommand(chatId, null, null);
  ...
  void startConfirmed_menuCampus_handlesNegativeFloorBlankCampusAndNullProgramValues() {
    ...
    campus.setClusters(List.of(new Clusters("  ", 2, 5, -1)));
  ...
  void startConfirmed_menuCampus_sortsProgramStatsWithNullAndNonNullValues() {
    ...
    verify(messageSender)
        .sendMessage(
            ...
            argThat(
                message ->
                    message.contains("⚡ Parallel 99: 0") && message.contains("🧢 Data Science: 1")),
            eq(null));
  }
