...
public final class ParticipantMessageFormatter {
  ...
  public static String format(ParticipantDto participant, List<ProjectsDto> projects) {
    ...
    message
        .append(statusEmoji(participant.getStatus()))
        .append(" ")
        .append(safe(participant.getLogin()))
        .append(DOUBLE_LINE_BREAK);
    message.append("🌊").append(safeOrDash(participant.getClassName())).append('\n');
    message
        .append("✨")
        .append(participant.getExpValue())
        .append(" XP (level ")
        .append(participant.getLevel())
        .append(")\n");
    message
        .append("\uD83D\uDC68\u200D\uD83D\uDCBB")
        .append(safeOrDash(participant.getParallelName()))
        .append(DOUBLE_LINE_BREAK);
  ...
  private static void appendCoalition(StringBuilder message, ParticipantDto participant) {
    ...
    String memberCount =
        coalition.getMemberCount() == null ? "-" : String.valueOf(coalition.getMemberCount());
    message
        .append("🦙")
        .append(coalition.getName())
        .append(" ")
        .append(rank)
        .append(" / ")
        .append(memberCount)
  ...
  private static void appendProjects(StringBuilder message, List<ProjectsDto> projects) {
    ...
    message.append("📁").append(names).append(DOUBLE_LINE_BREAK);
  }
  ...
  private static void appendPresence(StringBuilder message, ParticipantDto participant) {
    ...
    message
        .append("🕒")
        .append("Last online: ")
        .append(formatLastSeen(participant.getLastSeenAt()))
        .append("\n");
  }
