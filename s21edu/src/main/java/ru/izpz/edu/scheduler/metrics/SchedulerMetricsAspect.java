...
public class SchedulerMetricsAspect {
  ...
  public Object recordSchedulerMetrics(
      ProceedingJoinPoint pjp, TrackSchedulerMetrics trackSchedulerMetrics) throws Throwable {
    ...
    try {
      ...
      schedulerMetricsService.recordPhaseRequest(
          scheduler, phase, SchedulerPhaseRequestStatus.SUCCESS);
      ...
      schedulerMetricsService.recordPhaseRequest(
          scheduler, phase, SchedulerPhaseRequestStatus.FAILED);
      schedulerMetricsService.recordPhaseIssue(
          scheduler, phase, schedulerErrorClassifier.classify(throwable));
