...
class CampusRoutingProjectsProviderTest {
  ...
  @Mock private ObjectProvider<RestApiProjectsProvider> restProvider;
  @Mock private RestApiProjectsProvider restApiProjectsProvider;
  ...
  void getStudentProjectsByLogin_shouldUseRestProvider() {
    ...
    StudentProjectData project =
        new StudentProjectData("1", "name", null, null, null, null, null, null, null, null, null);
  ...
  void refreshStudentProjects_shouldCallRestProviderWhenAvailable() {
    ...
    CampusRoutingProjectsProvider.RefreshResult result =
        routingProvider.refreshStudentProjects(credentials);
