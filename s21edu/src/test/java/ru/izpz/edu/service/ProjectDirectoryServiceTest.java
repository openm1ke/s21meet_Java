...
class ProjectDirectoryServiceTest {
    ...
    void getProjectExecutors_shouldEscapeLikePatternAndFillCampusFromCatalog() {
        ...
        List<ProjectExecutorDto> result = service.getProjectExecutors(new ProjectExecutorsRequest(rawProjectName));
    ...
    void getProjectExecutors_shouldReturnEmptyAndSkipRepository_whenProjectNameBlank() {
        ...
        List<ProjectExecutorDto> result = service.getProjectExecutors(new ProjectExecutorsRequest("   "));
    ...
    void getProjectExecutors_shouldKeepCampusNameFromQuery_whenAlreadyPresent() {
        ...
        List<ProjectExecutorDto> result = service.getProjectExecutors(new ProjectExecutorsRequest("A1_Maze_C"));
    ...
    void getProjectExecutors_shouldNormalizeCampusNameToThreeLetterCode() {
        ...
        when(studentProjectRepository.findExecutorsByProjectName("A1\\_Maze\\_C"))
            .thenReturn(List.of(new ProjectExecutorDto("login2", "21 Moscow", "WAITING_FOR_START", null)));
        when(studentCredentialsRepository.findSchoolIdsByLogins(List.of("login2"))).thenReturn(List.of());
