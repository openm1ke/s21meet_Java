...
class CoalitionProviderConfigTest {
  ...
  void coalitionProvider_shouldReturnGraphQl_whenConfigured() {
    ...
    ObjectProvider<RestApiCoalitionProvider> restProvider = mockObjectProvider();
    ObjectProvider<GraphQLCoalitionProvider> graphProvider = mockObjectProvider();
    when(restProvider.getIfAvailable()).thenReturn(rest);
    when(graphProvider.getIfAvailable()).thenReturn(graph);

    CoalitionProviderConfig.CoalitionProperties properties =
        new CoalitionProviderConfig.CoalitionProperties();
